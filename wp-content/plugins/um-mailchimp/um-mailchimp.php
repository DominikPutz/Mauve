...
Plugin URI: http://ultimatemember.com/extensions/mailchimp
Description: Integrates Ultimate Member with MailChimp newsletters.
Version: 2.2.1
Author: Ultimate Member
Author URI: http://ultimatemember.com/
Text Domain: um-mailchimp
...
define( 'um_mailchimp_requires', '2.1.0' );
...
if ( ! function_exists( 'um_mailchimp_activation_hook' ) ) {
