    ...
    <div class="tab-content">
        <div id="tab-1" class="tab-pane <?php echo !isset($_POST["edit_taxonomy"]) ? 'active' : '' ?>">
			...
			<?php
				...
				foreach ($options as $option) {
					...
					settings_fields( 'mauve_plugin_tax_settings' );
        ...
        <div id="tab-2" class="tab-pane <?php echo isset($_POST["edit_taxonomy"]) ? 'active' : '' ?>">
            <form method="post" action="options.php">
                <?php
                    settings_fields( 'mauve_plugin_taxonomy_settings' );
                    do_settings_sections( 'mauve_taxonomy' );
                    submit_button();
                ?>
            </form>
        </div>
        ...
        <div id="tab-3" class="tab-pane">
            <h3>Export Your Taxonomies Types</h3>
        </div>
