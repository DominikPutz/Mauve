...
class TaxonomyCallbacks
{
    ...
    {
        $output = get_option( 'mauve_plugin_taxonomy' );
    ...
    public function textField( $args )
    {
        ...
        echo '<input type="text" class="regular-text" id="' . $name . '" name="' . $option_name . '[' . $name . ']" value="' . $value . '" placeholder="' . $args['placeholder'] . '" required ' . $active . '>';
    }
