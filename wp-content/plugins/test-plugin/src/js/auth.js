document.addEventListener('DOMContentLoaded', function (e) {
    const showAuthBtn = document.getElementById('mauve-show-auth-form'),
        authContainer = document.getElementById('mauve-auth-container'),
        close = document.getElementById('mauve-auth-close'),
        authForm = document.getElementById('mauve-auth-form'),
    ...
    authForm.addEventListener('submit', e => {
        ...
        let data = {
            ...
            nonce: authForm.querySelector('[name="mauve_auth"]').value
        }
