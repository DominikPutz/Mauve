...
<!-- um-profile-completeness/templates/completeness-bar.php -->
<span class="um-completeness-bar um-tip-n" title="<?php echo esc_attr( sprintf( __( '%s Complete', 'um-profile-completeness' ), $get_progress['progress'] . '%' ) ) ?>">
